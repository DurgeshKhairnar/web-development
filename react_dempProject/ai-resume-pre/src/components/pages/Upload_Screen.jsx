    ...
    return (
           <div className='mx-auto min-h-screen w=full max-w-[1000px] p-2 flex justify-center items-center flex-col'>
            ...
            items-center flex-col '>
               ...
               <div className='w-140 h-70 border-2 border-gray-200 flex justify-evenly items-center flex-col'>
                    <div className='h-20 w-20'>
                         <img src={document_upload} alt='img' />
                    </div>
